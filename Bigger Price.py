...
Your mission here is to find the TOP most expensive goods. The amount we 
are looking for will be given as a first argument and the whole data 
as the second one.
...
def bigger_price(limit, data):
    ...
    """
    # your code here
    data1 = [x["price"] for x in data]
    data2 = []
    j = 0
    while j < limit:
        j += 1
        for i in data:     
            if i["price"] == max(data1):
                data2.append(i)
